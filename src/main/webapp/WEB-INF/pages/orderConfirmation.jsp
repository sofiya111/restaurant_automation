...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <form action="/personalAccount" method="POST">
      Имя<br/>
      <input type="text" name="name" value="Иван"/><br/><br/>
      Телефон<br/>
      <input type="text" name="phoneNumber" value="89005005050"/><br/><br/>
      Email<br/>
      <input type="text" name="login" value="ivan202@gmail.com"/><br/><br/>
      Количество персон<br/>
      <input type="text" name="login" value="5"/><br/><br/>
      Дата и время бронирования<br/>
      <input type="text" name="date" value="31.03.2022 10:33"/><br/><br/>
      Номер столика<br/>
      <input type="text" name="table" value="10"/><br/><br/>
      <input type="hidden" name="cmd" value="PersonalAccount"/>
      <button class="btn btn-secondary">Подтвердить</button><br/><br/>
    </form>
    </div>
</body>
</html>
